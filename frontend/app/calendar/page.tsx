...
const PLATFORM_ICONS: Record<string, React.ReactNode> = {
  twitter: (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-200">
      <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5 5 9.2 5 9.2s1.5.8 3 .5C6.3 8.3 5 5.5 5 5.5s1.5 1.5 3 1.5c-4.4-3.5-2.2-9.6-2.2-9.6 3.5 3.5 8 5.6 12 6 .5-4.2 6.5-6.6 8.5-4z" />
    </svg>
  ),
  linkedin: (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="flex items-end mt-2 md:mt-0">
                <button
                  ...
                  className="w-full bg-linear-to-r from-[#7c3aed] to-[#d2bbff] hover:opacity-90 disabled:opacity-50 disabled:grayscale text-[#25005a] font-bold py-3 rounded-xl transition-all shadow-[0_4px_20px_-5px_rgba(124,58,237,0.4)]"
                >
